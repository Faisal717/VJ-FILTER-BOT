...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://abhay:store@store.nmvpb5w.mongodb.net/?retryWrites=true&w=majority&appName=STORE")   # IF Multiple Database Is False Then Fill Only This Database Url.
