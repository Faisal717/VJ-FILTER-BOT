...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002488377147'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002274695399') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002274695399')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Paisalleech:acBUQiOJK0Cwx2ql@cluster0.4kd3b.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/vj_bot_dussion')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/vbotz')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'vj_bisscussion') # Support Chat Link Without https:// or @
...
SHORTLINK_API = environ.get('SHORTLINK_API', '95d94a0b5b895d08fdb5431aef1a94dfd5d6923f')
